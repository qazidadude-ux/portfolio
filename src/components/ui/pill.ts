// Standard button sizing, taken from the nav Contact button: 20px × 6px padding, 14px text and a
// 1px border (transparent where a button has none), so every text button is the same height.
export const BUTTON_SIZE = "border px-5 py-1.5 text-sm font-medium";
